...
weighted_error = compute_errors(all_coefficients, all_indices, x1, esq.index_set.getIndexSet() )
equality_error = compute_errors(all_coefficients, all_indices, x1b, esq.index_set.getIndexSet() )

weighted_error = np.linalg.norm(weighted_error, 2)
equality_error = np.linalg.norm(equality_error, 2)
