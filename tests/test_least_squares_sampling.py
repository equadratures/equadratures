...
class TestC(TestCase):
    ...
    def test_qr(self):
        ...
        myPoly2 = Poly([zeta_1, zeta_2], myBasis2, method='least-squares', args={'mesh':'tensor-grid', 'subsampling-algorithm':'qr', 'sampling-ratio':1.0})
    ...
    def test_newton_svd(self):
        ...
        myPoly3 = Poly([zeta_1, zeta_2], myBasis3, method='least-squares', args={'mesh':'tensor-grid', 'subsampling-algorithm':'newton', 'sampling-ratio':1.0})
        pts3 = myPoly3.get_points()
        model_evals3 = evaluate_model(pts3, fun)
        myPoly3.set_model(model_evals3)

        myBasis4 = Basis('total-order')
        myPoly4 = Poly([zeta_1, zeta_2], myBasis3, method='least-squares', args={'mesh':'tensor-grid', 'subsampling-algorithm':'svd', 'sampling-ratio':1.0})
