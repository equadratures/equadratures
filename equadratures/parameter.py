...
class Parameter(object):
    ...
    **References**
    ...
    """
    def __init__(self, order=1, distribution=None, endpoints=None, shape_parameter_A=None, shape_parameter_B=None, name='parameter', lower=None, upper=None, data=None):
